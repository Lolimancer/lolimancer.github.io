 ...
 <body data-template-id="__page-root" style="background: rgb(36, 23, 19);">
   ...
   <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
    <div class="flex flex-col xl:flex-row xl:items-center gap-3 xl:gap-5">
     <div class="min-w-0 xl:flex-1">
      <p data-template-id="header-kicker" class="canva-text sans uppercase tracking-[.2em] mb-1" style="color: rgb(230, 201, 142); font-weight: 700; font-style: normal; font-size: 11px; letter-spacing: 0.18rem;">Tư tưởng • Cách mạng • Độc lập</p>
     ...
     <div class="flex items-center gap-2"><button id="music-toggle" data-template-id="music-toggle" class="canva-button audio-button sans rounded-full px-3 py-2 inline-flex items-center gap-2" type="button" aria-pressed="false" style="background: rgb(100, 32, 28); color: rgb(255, 255, 255);"> <i data-lucide="music-2" aria-hidden="true"></i> <span data-template-id="music-off-label" class="canva-text state-off" style="color: rgb(255, 255, 255); font-weight: 600; font-style: normal; font-size: 13px;">Phát nhạc</span> <span data-template-id="music-on-label" class="canva-text state-on" style="color: rgb(255, 255, 255); font-weight: 600; font-style: normal; font-size: 13px;">Dừng nhạc</span> </button> <button id="mute-toggle" data-template-id="mute-toggle" class="canva-button audio-button sans rounded-full px-3 py-2 inline-flex items-center gap-2" type="button" aria-pressed="false" disabled="" style="background: rgb(100, 32, 28); color: rgb(255, 255, 255);"> <i data-lucide="volume-2" aria-hidden="true"></i> <span data-template-id="mute-off-label" class="canva-text state-off" style="color: rgb(255, 255, 255); font-weight: 600; font-style: normal; font-size: 13px;">Tắt tiếng</span> <span data-template-id="mute-on-label" class="canva-text state-on" style="color: rgb(255, 255, 255); font-weight: 600; font-style: normal; font-size: 13px;">Bật tiếng</span> </button>
   ...
   <section data-template-id="hero-section" class="canva-section hero-section relative w-full overflow-hidden" style="background: rgba(36, 23, 19, 0.12);">
    ...
    <div class="relative w-full max-w-7xl mx-auto px-6 lg:px-8 py-20 lg:py-28">
     <div class="max-w-3xl text-white">
      ...
      <h2 data-template-id="hero-title" class="canva-text font-bold leading-[1.02] mb-6" style="color: rgb(255, 248, 233); font-weight: 700; font-style: normal; font-size: 58px; line-height: 1.03;">Tư tưởng lan tỏa. Cách mạng đáp lời. Dân tộc được kiến tạo lại.</h2>
  ...
  <footer data-template-id="footer-section" class="canva-footer w-full py-8" style="background: rgba(56, 23, 20, 0.95);">
   <div class="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
    <p data-template-id="footer-text" class="canva-text text-center sm:text-left" style="color: rgb(230, 213, 185); font-weight: 400; font-style: normal; font-size: 14px;">Tổng quan lịch sử tương tác • Ngày tháng theo lịch Gregory • Nhạc là tùy chọn</p><button id="back-to-top" data-template-id="back-to-top" class="canva-button inline-flex items-center gap-2 rounded-sm px-4 py-2 sans font-bold" type="button" style="background: rgb(169, 42, 35); color: rgb(255, 255, 255); font-weight: 700; font-style: normal; font-size: 14px;">Về đầu trang</button>
   </div>
  </footer>
